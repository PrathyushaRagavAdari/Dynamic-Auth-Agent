...
* **Product Lead:** Defined the "Auditor" persona and success metrics (Time-to-Verification < 3s).
* **Systems Lead:** Implemented the Hybrid RAG pipeline (Dense + Sparse) and Multimodal ingestion (OCR for charts).
* **Risk Lead:** Designed the "Refusal Protocol" to ensure the bot does not hallucinate legal advice outside of the provided NIST documents.
